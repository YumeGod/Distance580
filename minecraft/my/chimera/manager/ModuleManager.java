...
import my.chimera.util.render.gl.GLUtils;
import me.guichaguri.betterfps.BetterFpsConfig;
import my.chimera.module.modules.combat.*;
import my.chimera.module.modules.move.*;
import my.chimera.module.modules.player.*;
import my.chimera.module.modules.render.*;
import my.chimera.module.modules.world.*;
...
public class ModuleManager implements Manager {
	...
	public void init() {
		...
		System.out.println("==========================================");
		System.out.println(Client.name + " Client "+ Client.chimeraVersion);
		System.out.println("==========================================");
