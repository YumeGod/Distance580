...
import my.chimera.fastuni.FastUniFontRenderer;
...
import my.chimera.module.modules.world.Scaffold;
import my.chimera.ui.font.CFontRenderer;
import my.chimera.ui.font.FontLoaders;
import my.chimera.ui.jello.Compass;
import my.chimera.ui.notifications.user.Notifications;
import my.chimera.util.Vec3;
import my.chimera.util.anim.AnimationUtil;
import my.chimera.util.anim.AnimationUtils;
import my.chimera.util.anim.Palette;
        ...
        if (!Widget.getValue().equals(widgetE.None) && !Widget.getValue().equals(widgetE.Astolfo)) {
            ...
            switch ((logomodeE) logomode.getValue()) {
                ...
                case Distance:
                    ...
                    dfont2.drawString(Client.chimeraVersion, animLogoX + 2f, animLogoY + 24, new Color(255, 255, 255).getRGB());
                    //GL11.glDisable(3042);
                    break;
                case Jigsaw: {
