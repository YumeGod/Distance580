package my.chimera.ui.gui.clikguis.clickgui4;
...
public class ClickGui extends GuiScreen implements GuiYesNoCallback {
	...
	private final int ClientColors = my.chimera.module.modules.render.ClickGui.CustomColor.getValue()? Client.getClientColor() : Client.getBBlueColor();
