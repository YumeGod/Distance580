package my.chimera.ui.gui.verify;
...
import my.chimera.ui.BackGroundRenderer;
import my.chimera.ui.buttons.UIFlatButton;
import my.chimera.ui.font.FontLoaders;
import my.chimera.ui.gui.GuiWelcome;
import my.chimera.ui.jelloparticle.ParticleEngine;
import my.chimera.util.anim.AnimationUtil;
import my.chimera.util.anim.AnimationUtils;
import my.chimera.util.misc.ObfuscatedUtils;
import my.chimera.util.render.Blur;
import my.chimera.util.render.Colors;
...
public class GuiLogin extends GuiScreen {
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		FontLoaders.GoogleSans16.drawString(Client.name + " made by \u00a7oMymylesaws\u00a7r (Chimera Team)", width -
						FontLoaders.GoogleSans16.getStringWidth(Client.name+" made by \u00a7oMymylesaws\u00a7r (Chimera Team)") - 1,
				...
				if (animIntro1 != 1) {
					...
					if (timerUtil.hasReached(1100)) {
						...
						if ((animIntro6 != 0 || animIntro7 != 0) && animIntro8 >= 1) {
							...
							FontLoaders.calibrilite35.drawCenteredString(Client.chimeraVersion, ((w / 2f + FontLoaders.calibrilite35.getStringWidth(Client.name)) - 10) + 0.7f, (((h / 2f) + 1) - (FontLoaders.calibrilite50.getHeight() / 2f)) + 0.7f, new Color(0, 0, 0, Math.max(Math.min((int) animIntro8,100),1)).getRGB());
							...
							FontLoaders.calibrilite35.drawCenteredString(Client.chimeraVersion, (w / 2f + FontLoaders.calibrilite35.getStringWidth(Client.name)) - 10, ((h / 2f) + 1) - (FontLoaders.calibrilite50.getHeight() / 2f), new Color(255, 255, 255, (int) animIntro8).getRGB());
