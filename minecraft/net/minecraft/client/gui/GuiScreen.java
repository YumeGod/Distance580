...
import my.chimera.ui.particles.ParticleManager;
import my.chimera.ui.particles.particle.ParticleSnow;
import my.chimera.util.SuperLib;
...
//            this.drawGradientRect(l1 - 3, i2 + k + 2, l1 + i + 3, i2 + k + 3, j1, j1);
    ...
    public void drawWorldBackground(int tint)
    {
        if (this.mc.theWorld != null)
        {
            ...
            FontLoaders.calibrilite35.drawStringWithShadow(Client.name,width-FontLoaders.calibrilite35.getStringWidth(Client.name)-FontLoaders.calibrilite15.getStringWidth(Client.chimeraVersion) - 5,height-FontLoaders.calibrilite35.getStringHeight(Client.name),new Color(255,255,255,200).getRGB());
            FontLoaders.calibrilite15.drawStringWithShadow(Client.chimeraVersion,width-FontLoaders.calibrilite15.getStringWidth(Client.chimeraVersion) - 3,height-FontLoaders.calibrilite35.getStringHeight(Client.chimeraVersion) / 2f - 2,new Color(255,255,255,200).getRGB());
        }
        else
        {
