...
import my.chimera.api.EventBus;
import my.chimera.api.events.Misc.EventKey;
import my.chimera.api.events.World.EventAttack;
import my.chimera.api.events.World.EventTick;
import my.chimera.api.events.World.EventWorldChanged;
import my.chimera.api.verify.SHWID;
import my.chimera.ui.gui.mainmenu.GuiMainMenu;
import my.chimera.ui.gui.GuiNeedBlur;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        try {
            System.out.println("////////Chimera is Start Load ViaVersion////////////");
            System.out.println("Chimera正在加载跨版本模块可能会导致一些bug");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Minecraft 1.8.9 | Chimera");
    ...
    public void drawSplashScreen(int much) {
        ...
        GlStateManager.alphaFunc(516, 0.1F);
        much = much / 10;
        Display.setTitle("Minecraft 1.8.9 | Chimera !正在加载，很快就好 " + much + "/6");
        this.updateDisplay();
    }
